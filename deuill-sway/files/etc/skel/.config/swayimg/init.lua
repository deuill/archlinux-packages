...
swayimg.viewer.on_key("Ctrl+n", function() swayimg.viewer.switch_image("next_dir") end)
swayimg.viewer.on_key("Ctrl+p", function() swayimg.viewer.switch_image("prev_dir") end)
